...
public enum AppErrorCodeEnum {
    ...
    CONFIGURATION_TRIPLET_NOT_ASSOCIATED("ATMLM_4000049","The referenced configuration has no associations for the referenced funtionType. Create an association before replacing it", CANNOT_REPLACE_ASSOCIATION),
    WORKFLOW_RESOURCE_INTERNAL_ERROR("ATMLM_4000050","No file associated to workflow resource or no storage key found", INTERNAL),
    BPMN_INTERNAL_ERROR("ATMLM_4000050","No file associated to BPMN or no storage key found", INTERNAL);
