...
public enum AppErrorCodeEnum {
    ...
    BPMN_CANNOT_BE_DISABLED_FOR_ASSOCIATIONS("ATMLM_4000037", "The referenced BPMN file has associations and cannot be disabled", CANNOT_DISABLE),
    BPMN_ALREADY_DISABLED("ATMLM_4000038", "The referenced BPMN file is already disabled", CANNOT_DISABLE);
