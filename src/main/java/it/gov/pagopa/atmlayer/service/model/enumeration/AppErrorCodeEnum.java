...
public enum AppErrorCodeEnum {
    ...
    WORKFLOW_RESOURCE_CANNOT_BE_UPDATED("ATMLM_4000028", "The referenced Workflow Resource file can not be updated", NOT_UPDATABLE),
    RESOURCE_FILE_DOES_NOT_EXIST("ATMLM_4000029", "The referenced Resource file does not exist", NOT_EXISTING_REFERENCED_ENTITY);
