...
public enum AppErrorCodeEnum {
    ...
    PROFILE_ALREADY_EXIST("ATMLM_4000053", "Esiste già un profilo con lo stesso id", CONSTRAINT_VIOLATION),
    PROFILE_NOT_FOUND("ATMLM_4000054", "Non esiste un profilo con l'id indicatio", CONSTRAINT_VIOLATION);
